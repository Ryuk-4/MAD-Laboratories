...
public class ReservationActivity_Old extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener,
        //RecyclerViewAdapterReservation.OnReservationListener,
        RecyclerItemTouchHelper.RecyclerItemTouchHelperListener {

    private static final String TAG = "ReservationActivity_Old";
...
/*
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText(ReservationActivity_Old.this, "Pressed +", Toast.LENGTH_LONG).show();
            }
        });
*/
   ...
   /* private void initializeReservation() {
    ...
    private void initializeRecyclerViewReservation() {
        ...
        myAdapter = new RecyclerViewAdapterReservation(ReservationActivity_Old.this,
        ...
        ItemTouchHelper.SimpleCallback itemTouchHelperCallback = new RecyclerItemTouchHelper(0,
                ItemTouchHelper.LEFT | ItemTouchHelper.RIGHT, this, ReservationActivity_Old.this);
...
/*
    ...
    public void OnReservationClick(int position) {
        ...
        Intent intent = new Intent(ReservationActivity_Old.this, ReservationEditActivity.class);
...
/*
 *  TODO: Tre tab -> In entrata, In preparazione, Da Consegnare
 *  TODO:2 azioni per lo swipe nel primo tab, 1 nel secondo
 */